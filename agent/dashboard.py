...
def sidebar_html(activa: str, stats: dict | None = None) -> str:
    ...
    nav = [
        ...
        ("contenido", "🎬 Contenido", "/admin/contenido", 0,
         '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="m10 9 5 3-5 3V9z"/></svg>'),
